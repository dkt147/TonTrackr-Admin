<?php
$pageTitle = 'Tickets Export - Fleet Contractor Statement';
$activePage = 'reports';
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>TonTrackr · Tickets Export - Fleet Contractor Statement</title>
    ...
    <div class="report-container">
        ...
        <div class="report-header">
            <div class="report-title-section">
                ...
                <p style="font-size: 14px; color: #666; margin-top: 8px;">(Registered Title)</p>
            </div>
        ...
        <div class="info-section">
            <div class="info-group">
                ...
                <div class="info-value">Fleet Logistics Inc</div>
                <div class="info-subvalue">123 Riverside Drive</div>
                <div class="info-subvalue">Springfield, ID 83205</div>
            </div>
            <div class="info-group">
                <div class="info-label">Fleet Manager</div>
                <div class="info-value">Operations Team</div>
                <div class="info-subvalue">USDOT License Avg.</div>
            </div>
            <div class="info-group">
                <div class="info-label">Fleet Details</div>
                <div class="info-value">Multi-Vehicle Fleet</div>
                <div class="info-subvalue">USDOT: 3844103</div>
            </div>
        </div>
        ...
        <h2 class="section-title">Fleet Ticket Summary by Vehicle</h2>
        <table>
            <thead>
                <tr>
                    <th>Ticket #</th>
        ...
        <div style="text-align: right; margin: 20px 0; padding: 20px; background: #f9f9f9; border-radius: 8px;">
            ...
            <div style="font-size: 24px; font-weight: 700; color: #5ba639;">$20,661.93</div>
        </div>

        <div class="footer-note">
            This statement shows all tickets issued to the fleet for the specified period. Records retained per FTA
            requirements. Generated by TonTrackr | Fleet | Reports | Page 1 of 1
        </div>
    </div>
</body>
