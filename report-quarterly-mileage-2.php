...
<head>
    ...
    <title>TonTrackr · Quarterly Mileage Summary - Page 2</title>
...
<body>
    <div class="report-container">
        <div style="margin-bottom: 20px; display: flex; justify-content: flex-end; gap: 12px;">
            <button class="btn-back" onclick="window.location.href='report-quarterly-mileage.php'">← Back to Page
                1</button>
        ...
        <div class="report-header">
            <div class="report-title-section">
                ...
                <h1>Quarterly Mileage Summary, page 2</h1>
            </div>
        ...
        <div class="footer-note">
            ...
            regulations). Generated by TonTrackr | Fleet | Q2 2026 | Page 2 of 3
        </div>
    </div>
</body>
